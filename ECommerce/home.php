          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>W</span>YSIWYG</h1>
                  <h2>Just as our name suggests</h2>
              ...
              <div class="item">
                <div class="col-sm-6">
                <h1><span>W</span>YSIWYG</h1>
                  <h2>Afordable prices</h2>
                  <p>Save over 30% on clothes of all kinds</p>
                </div>
                <div class="col-sm-6">
              ...
              <div class="item">
                <div class="col-sm-6">
                <h1><span>W</span>YSIWYG</h1>
                  <h2>Easy refunding</h2>
                  <p>We have a very flexible refunding policy</p>
